...
if (best >= 1) badges.push({ icon: "🌱", title: "Getting Started" });

if (best >= 7) badges.push({ icon: "🔥", title: "7 Day Streak" });

if (longest >= 30) badges.push({ icon: "🏆", title: "30 Day Champion" });

if (monthly >= 80) badges.push({ icon: "⭐", title: "Consistency Star" });

if (monthly === 100) badges.push({ icon: "👑", title: "Perfect Month" });
  ...
  function handleDownload() {
    ...
    ctx.fillText('FocusFlow.app · build one habit at a time', 20, H - 10)

    const a = document.createElement('a')
    a.download = 'FocusFlow-card.png'
      ...
      <div className="card-section">
        ...
        <div className="hf-card">
          <div className="hf-card-band">
            <div className="hf-band-label">FocusFlow</div>
          ...
          <div className="hf-card-foot">FocusFlow.app · build one habit at a time</div>
        </div>
